...
.setColor("#9B59B6")
.addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/ptGykqG*")
...
if (message.content.toLowerCase().startsWith(prefix + `new`)) {
    ...
    if (message.guild.channels.exists("name", "ticket_" + message.author.id)) return message.channel.send(`You already have a ticket open.`);
